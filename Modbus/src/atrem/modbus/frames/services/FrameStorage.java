...
public class FrameStorage {
	...
	private void SysOutPairFrame(RequestFrame requestFrame, ResponseFrame responseFrame) {
	...
	private void removePairedFrame(RequestFrame requestFrame, ResponseFrame responseFrame) {
