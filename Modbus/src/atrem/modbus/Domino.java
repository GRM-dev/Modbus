...
public class Domino {
	...
	public void receiveConnectionParameters(String ip, int port) throws IOException {
	...
	public void creatRequestFrameFactory(int unitIdentifier, int startingAdress,
			int quantityOfRegisters, int functionCode) {
